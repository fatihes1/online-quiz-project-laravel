<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('ki faktörlü kimlik doğrulama etkinleştirildiğinde, kimlik doğrulama sırasında güvenli, rastgele bir jeton istenir. Bu jetonu telefonunuzun Google Authenticator uygulamasından alabilirsiniz.') }}
            </p>
        </div>
